...
def cnn(input_data, out_channels, batch_size):
    ...
    with tf.variable_scope('conv3') as scope:
        conv3= ops.conv2d(pool2, 3, 5, 32, 32, padding='VALID', kernel_summary=True, name=scope.name)
    pool3 = ops.max_pooling(conv3, 2, 2, padding='VALID', name='pool3')
