...
tf.app.flags.DEFINE_integer('epoch', 200, """The max iterations the model will be trained""")
tf.app.flags.DEFINE_integer('num_examples_train', 758, """The examples that the training set has""")
tf.app.flags.DEFINE_integer('common_num_examples_train', 758, """The examples that the training set has""")
tf.app.flags.DEFINE_integer('num_examples_test', 97, """The examples that the test set has""")
...
tf.app.flags.DEFINE_string('common_train_input_path',r'D:\MasterDL\trans\nhnx\tfrecords\common\train\train.tfrecords',"""The diretory where the input data for common trainning saved in.""")
tf.app.flags.DEFINE_string('common_test_input_path', r'D:\MasterDL\trans\nhnx\tfrecords\common\test\test.tfrecords', """The diretory where the input data for common testing saved in.""")
...
tf.app.flags.DEFINE_string('common_train_today_mat_dir', r'D:\MasterDL\data_set\traffic_data\2011_nhnx_speed\new\train\common\today_augment', """To be done.""")
tf.app.flags.DEFINE_string('common_train_tomorrow_mat_dir', r'D:\MasterDL\data_set\traffic_data\2011_nhnx_speed\new\train\common\tomorrow_augment', """To be done.""")
tf.app.flags.DEFINE_string('common_test_today_mat_dir', r'D:\MasterDL\data_set\traffic_data\2011_nhnx_speed\new\test\common\today', """To be done.""")
tf.app.flags.DEFINE_string('common_test_tomorrow_mat_dir', r'D:\MasterDL\data_set\traffic_data\2011_nhnx_speed\new\test\common\tomorrow', """To be done.""")


NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 758
NUM_EXAMPLES_PER_EPOCH_FOR_COMMON_TRAIN = 758
