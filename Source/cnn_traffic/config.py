...
tf.app.flags.DEFINE_string('test_input_path', 'D:\\MasterDL\\data_set\\traffic_data\\speed\\tfrecords\\test\\test.tfrecords', """The diretory where the input data for testing saved in.""")
tf.app.flags.DEFINE_string('test_today_mat_dir','D:\\MasterDL\\data_set\\traffic_data\\speed\\test\\today\\',"""To be done""")
tf.app.flags.DEFINE_string('test_tomorrow_mat_dir','D:\\MasterDL\\data_set\\traffic_data\\speed\\test\\tomorrow\\',"""To be done""")
