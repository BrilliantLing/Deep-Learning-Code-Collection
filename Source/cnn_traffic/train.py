...
def train():
    with tf.Graph().as_default():
        ...
        ltoday, mtoday, htoday, mtomorrow = rec.train_input(
            FLAGS.train_input_path,
            FLAGS.train_batch_size,
            conf.shape_dict,
            30
        )
        predictions = cnn_branches.cnn_with_branch(ltoday,mtoday,htoday,conf.HEIGHT*conf.MID_WIDTH, FLAGS.train_batch_size)
        ...
        for step in xrange(FLAGS.epoch*conf.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN):
