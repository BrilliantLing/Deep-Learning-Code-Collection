...
tf.app.flags.DEFINE_string('eval_dir', 'D:\\MasterDL\\data_set\\cifiar\\cifar10_eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', 'D:\\MasterDL\\data_set\\cifiar\\cifar10_train',
